...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    children: [
      { label: '54 Litre Industrial Bin Only',      path: '/products/containers/54-litre-bin' },
      { label: '44 Litre Industrial Bin & Lid',     path: '/products/containers/44-litre-bin' },
      { label: 'Handy Case',                         path: '/products/containers/handy-case' },
    ],
  },
  {
    label: 'BSP Fittings',
    path: '/products/bsp-fittings',
    children: [
      { label: 'BSP Bung Cap',                          path: '/products/bsp-fittings/bsp-bung-cap' },
      { label: 'BSP Adaptor Washer Set',                path: '/products/bsp-fittings/bsp-adaptor-washer-set' },
      { label: 'BSP Adaptor',                           path: '/products/bsp-fittings/bsp-adaptor' },
      { label: 'BSP Washer',                            path: '/products/bsp-fittings/bsp-washer' },
      { label: 'Camlock Adaptor, Cap and Washer Set',   path: '/products/bsp-fittings/camlock-adaptor-cap-washer-set' },
      { label: 'Camlock Adaptor',                       path: '/products/bsp-fittings/camlock-adaptor' },
      { label: 'Camlock Bung Cap',                      path: '/products/bsp-fittings/camlock-bung-cap' },
      { label: 'Camlock Washer',                        path: '/products/bsp-fittings/camlock-washer' },
    ],
  },
  {
    label: 'Home Brew Products',
    path: '/products/home-brew',
    children: [
      { label: 'Bottle Draining Tree',          path: '/products/home-brew/bottle-draining-tree' },
      { label: 'Snap Tap - Standard',            path: '/products/home-brew/snap-tap-standard-34-unf' },
      { label: 'Snap Tap - Female',              path: '/products/home-brew/snap-tap-female-38-bsp' },
      { label: 'Snap Tap - 44mm Long Thread',    path: '/products/home-brew/snap-tap-44mm-long-thread' },
      { label: 'Snap Tap - 3/4 BSP',             path: '/products/home-brew/snap-tap-34-bsp' },
      { label: 'Push Button Tap',                path: '/products/home-brew/push-button-tap' },
      { label: 'Snap Tap - Box',                 path: '/products/home-brew/snap-tap-box-25-34-bsp' },
    ],
  },
  {
    label: 'Taps',
